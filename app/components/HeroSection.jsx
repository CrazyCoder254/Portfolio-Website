...
const HeroSection = () => {
  return (
    <section className='pt-20 lg:pt-32 lg:py-16'>
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <motion.div initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale:1 }} transition={{ duration: 0.5 }} className="col-span-8 place-self-center text-center sm:text-left justify-self-start">
          <h1 className="text-white mb-4 text-3xl sm:text-4xl lg:text-7xl lg:leading-normal font-extrabold">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">Hello, I&apos;m Ken{""}</span>
            <br />
            <TypeAnimation
              sequence={[
                'Software Engineer',
          ...
          <div>
            ...
            <a target="_blank" href="KenCV.pdf" className='w-full sm:w-fit'>
              <button className='px-1 py-1 rounded-full bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 hover:bg-slate-800 text-white mt-3'>
                <span className='block bg-[#121212] hover:bg-slate-000 rounded-full px-5 py-2'>Download CV</span>
              </button>
            </a>
          </div>
        </motion.div>
